...
疫情被封闭在家一个月时间，远程居家办公也许比在公司上班还要“卷”。当然生活要继续，工作要继续，学习也要继续，于是突发奇想，开始捣鼓一下 ChromeOS，也是想拥抱一些新鲜事物，看看能否将现在的事情转移到 ChromeOS 系统上。于是有了这一篇文章，帮助那些未来想要把工作、娱乐、学习转移到 ChromeOS 的同学踩踩坑。
